pipeline {
    agent any
    parameters {
        string(name: 'BUILD_PATH', defaultValue: 'base/postcode', description: 'path from which images need to be built')
        string(name: 'IMAGE_NAME', defaultValue: 'apropos-postcode-base', description: 'Image name to publish')
