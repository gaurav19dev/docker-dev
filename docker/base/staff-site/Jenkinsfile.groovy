pipeline {
    agent any
    parameters {
        string(name: 'BUILD_PATH', defaultValue: 'base/staff-site', description: 'path from which images need to be built')
        string(name: 'IMAGE_NAME', defaultValue: 'apropos-staff-site-base', description: 'Image name to publish')
