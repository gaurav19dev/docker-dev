pipeline {
    agent any
    parameters {
        string(name: 'BUILD_PATH', defaultValue: 'prod/staff-site', description: 'path from which images need to be built')
        string(name: 'IMAGE_NAME', defaultValue: 'apropos-staff-site-prod', description: 'Image name to publish')
