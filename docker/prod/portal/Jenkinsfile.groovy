pipeline {
    agent any
    parameters {
        string(name: 'BUILD_PATH', defaultValue: 'prod/portal', description: 'path from which images need to be built')
        string(name: 'IMAGE_NAME', defaultValue: 'apropos-portal-prod', description: 'Image name to publish')
