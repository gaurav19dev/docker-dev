pipeline {
    agent any
    parameters {
        string(name: 'BUILD_PATH', defaultValue: 'prod/worklog-cron', description: 'path from which images need to be built')
        string(name: 'IMAGE_NAME', defaultValue: 'apropos-worklog-cron-prod', description: 'Image name to publish')
