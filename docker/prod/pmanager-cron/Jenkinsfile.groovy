pipeline {
    agent any
    parameters {
        string(name: 'BUILD_PATH', defaultValue: 'prod/pmanager-cron', description: 'path from which images need to be built')
        string(name: 'IMAGE_NAME', defaultValue: 'apropos-pmanager-cron-prod', description: 'Image name to publish')
